...
<section id="page" class="backgroundf7f7f7">
	<div class="container">
		<h1 class="clientareaPageTitle">Güvenlik</h1>
...
<section id="page">
  <div class="container">
    ...
    <div class="alert alert-info text-center">
      İki faktörlü kimlik doğrulama şirket tarafından devredışı bırakıldı.
    </div>
    {/if}
    ...
    {else}
    <div class="alert alert-info text-center">
      Şirket tarafından güvenlik sorusu ve güvenlik cevabı sistemi devredışı bırakıldı.
    </div>
    {/if}
