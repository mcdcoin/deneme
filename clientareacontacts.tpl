...
<section id="page" class="backgroundf7f7f7">
	<div class="container">
		<h1 class="clientareaPageTitle">Sorumluyu Düzenleyin</h1>
		<p>Hesabınıza ait sorumluyu düzenleyin.</p>
	</div>
</section>
<section id="page">
  <div class="container">
		        ...
		        <form role="form" method="post" action="{$smarty.server.PHP_SELF}?action=contacts&id={$contactid}">
		            ...
		            <div class="row">
		                <div class="col-sm-6">
		                    ...
		                    <div class="form-group">
		                        ...
		                        <input type="text" name="firstname" id="inputFirstName" value="{$contactfirstname}" class="basic-input-control" />
		                    </div>

		                    <div class="form-group">
		                        <label for="inputLastName" class="control-label">{$LANG.clientarealastname}</label>
		                        <input type="text" name="lastname" id="inputLastName" value="{$contactlastname}" class="basic-input-control" />
		                    </div>

		                    <div class="form-group">
		                        <label for="inputCompanyName" class="control-label">{$LANG.clientareacompanyname}</label>
		                        <input type="text" name="companyname" id="inputCompanyName" value="{$contactcompanyname}" class="basic-input-control" />
		                    </div>

		                    <div class="form-group">
		                        <label for="inputEmail" class="control-label">{$LANG.clientareaemail}</label>
		                        <input type="email" name="email" id="inputEmail" value="{$contactemail}" class="basic-input-control" />
		                    </div>

		                    <div class="form-group">
		                        <label for="inputPhone" class="control-label">{$LANG.clientareaphonenumber}</label>
		                        <input type="tel" name="phonenumber" id="inputPhone" value="{$contactphonenumber}" class="basic-input-control" />
		                    </div>
		                ...
		                <div class="col-sm-6 col-xs-12 pull-right">
		                    ...
		                    <div class="form-group">
		                        ...
		                        <input type="text" name="address1" id="inputAddress1" value="{$contactaddress1}" class="basic-input-control" />
		                    </div>

		                    <div class="form-group">
		                        <label for="inputAddress2" class="control-label">{$LANG.clientareaaddress2}</label>
		                        <input type="text" name="address2" id="inputAddress2" value="{$contactaddress2}" class="basic-input-control" />
		                    </div>

		                    <div class="form-group">
		                        <label for="inputCity" class="control-label">{$LANG.clientareacity}</label>
		                        <input type="text" name="city" id="inputCity" value="{$contactcity}" class="basic-input-control" />
		                    </div>

		                    <div class="form-group">
		                        <label for="inputState" class="control-label">{$LANG.clientareastate}</label>
		                        <input type="text" name="state" id="inputState" value="{$contactstate}" class="basic-input-control" />
		                    </div>

		                    <div class="form-group">
		                        <label for="inputPostcode" class="control-label">{$LANG.clientareapostcode}</label>
		                        <input type="text" name="postcode" id="inputPostcode" value="{$contactpostcode}" class="basic-input-control" />
		                    </div>
		            ...
		            <div id="subacct-container" class="well{if !$subaccount} hidden{/if}">
		                ...
		                <fieldset class="form-horizontal">
		                    <div id="newPassword1" class="form-group has-feedback">
		                        ...
		                        <div class="col-sm-6">
		                            <input type="password" class="basic-input-control" id="inputNewPassword1" name="password" autocomplete="off" />
		                    ...
		                    <div id="newPassword2" class="form-group has-feedback">
		                        ...
		                        <div class="col-sm-6">
		                            <input type="password" class="basic-input-control" id="inputNewPassword2" name="password2" autocomplete="off" />
		                            <span class="form-control-feedback glyphicon"></span>
		            ...
		            <div class="form-group text-center">
		                <input class="standartButon yesil-buton" type="submit" name="save" value="{$LANG.clientareasavechanges}" />
		                <input class="standartButon" type="reset" value="{$LANG.cancel}" />
		                <input class="standartButon kirmizi-buton" type="button" value="{$LANG.clientareadeletecontact}" onclick="deleteContact('{$LANG.clientareadeletecontactareyousure}', {$contactid})" />
		            </div>
