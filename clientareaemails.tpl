...
<section id="page" class="backgroundf7f7f7">
	<div class="container">
		<h1 class="clientareaPageTitle">E-Postalarım</h1>
		<p>Posta adresinize gönderilen postalar.</p>
	</div>
</section>
<section id="page">
  <div class="container">
    ...
    <div class="table-container clearfix">
        <table id="tableEmailsList" class="table table-list hidden table-responsive">
            <thead>
                <tr>
